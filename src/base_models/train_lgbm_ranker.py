...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("LGBM_Ranker_Optimization")

    with mlflow.start_run(run_name="LGBM_Ranker_Training_Tuning") as parent_run:
        ...
        oof_file_path = os.path.join(output_loc, "lgbm_ranker_oof_preds.parquet")
        if os.path.exists(oof_file_path):
            mlflow.log_artifact(oof_file_path)
            
        mlflow.lightgbm.log_model(lgbm_ranker_final, artifact_path="lgbm_ranker_base_model")
